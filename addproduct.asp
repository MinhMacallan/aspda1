...
If(Request.ServerVariables("REQUEST_METHOD")="POST")THEN
    ...
    If (NOT IsNull(tensp) AND NOT isnull(theloai)) Then 'kiem tra xem tensp va the loai da ton tai hay chua'
        ...
        cmdPrep.CommandText ="SELECT * FROM Sanpham WHERE tensp=? AND theloai = ?"
        ...
        If Result.EOF then 
            ...
            cmdPrepp1.CommandText = "Insert into Sanpham (tensp,theloai,gioithieu,giaban,slton,anhm,anh1,anh2,anh3,anh4,anh5,anht,anhb) values (?,?,?,?,?,?,?,?,?,?,?,?,?)"
        ...
        Else
            Session("Error") = "San pham da ton tai"
        End If
    End If
End If
