...
<body>
    ...
    <div class="list">
        ...
        <% sql="select * from Pay where IDCus=? " 
        Dim cmdPrep 
        ...
        cmdPrep.Parameters(0) = Cint(Session("id"))
        Dim result
        set result = cmdPrep.execute()
            While not result.EOF 
            %>
            <div class="oder">
            <a href="detailorder.asp?id=<%=result("IDPay")%>">
            </a>
                <div class="oder-info" name="idpay">
                    <div class="sub">
                        Oder's ID
                        <div class="pric"><%=result("IDPay")%></div>
                    </div>
                    <div class="sub" name="datepay">
                        Day created
                        <div class="pric"><%=result("Datepay")%></div>
                    </div>
                    <div class="sub" name="totalpay">
                        Total
